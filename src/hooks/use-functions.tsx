...
interface UseFunctionsReturn {
  loading: { data: boolean; slots: boolean; appointment: boolean }
  data?: PublicInformation
  createAppointment: (payload: AppointmentRequestData) => Promise<boolean>
  getTimeSlots: () => void
  error?: { data: string | null; slots: string | null; appointment: string | null }
}
...
export const FunctionsContext = createContext<UseFunctionsReturn>({
  loading: { data: true, slots: false, appointment: false },
  error: { data: null, slots: null, appointment: null },
...
export const FunctionsProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const result: UseFunctionsReturn = {
    loading: { data: isDataLoading, slots: isSlotsLoading, appointment: isAppointmentLoading },
    data,
    createAppointment,
    getTimeSlots,
    error: { data: dataError, slots: slotsError, appointment: appointmentError }
  }
