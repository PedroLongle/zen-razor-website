...
export default function PhoneInput({
  ...
  const [selectedCountry, setSelectedCountry] = useState<Country>(countries.find((c) => c.code === defaultCountry) || countries[0])
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const syntheticEvent = { target: { name: register.name, value: fullPhoneNumber, type: "tel" }, type: "change" }
  ...
  // Destructure register to avoid accessing refs during render
