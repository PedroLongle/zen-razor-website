...
const GoogleMapComponent = dynamic(() => import("./map"), { ssr: false })
...
export default function MapWrapper({
  ...
  height = "400px",
  markerColor = "#FF0000",
  locationInfo = { address: "Loading...", city: "", country: "", latitude: 0, longitude: 0 }
}: MapWrapperProps) {
  return (
    <div className="space-y-4">
      ...
      {locationInfo.address && (
        <div className="text-center font-sans text-muted-foreground">
          <p>
            {locationInfo.address} {locationInfo.city && `• ${locationInfo.city},`} {locationInfo.country && `${locationInfo.country}`}
          </p>
