  ...
  return (
    ...
    (
      <div className="flex flex-col min-h-screen">
        {/* Hero Section */}
        <section className="relative w-full flex items-center bg-[url(/images/home.png)] bg-cover bg-center sm:bg-center md:bg-center lg:bg-center bg-no-repeat h-screen sm:h-screen md:h-[50rem] lg:h-[50rem] xl:h-[50rem]">
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
            <div className="flex flex-col justify-center py-8 sm:py-12 md:py-20">
              ...
              <p className="text-sm sm:text-base md:text-lg max-w-xl mb-6 sm:mb-8 font-sans leading-relaxed">{t("hero.description")}</p>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto font-sans">{t("services.description")}</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-muted-foreground mb-6 font-sans">{t("about.description")}</p>
                <p className="text-muted-foreground mb-8 font-sans">{t("about.experience")}</p>
                <Link
                  href="/about"
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto font-sans">{t("team.description")}</p>
            </div>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8 font-sans">{t("cta.description")}</p>
            <Link
              href="/appointments"
              className="inline-flex h-10 items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium text-foreground ring-offset-background transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 font-sans">
              {t("hero.bookAppointment")}
